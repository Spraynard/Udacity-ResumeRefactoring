...
var HTMLlinkedin = '<li class="flex-item"><span class="black-text">LinkedIn</span><span class="white-text">%data%</span></li>';
...
var HTMLworkEmployer = '<a href="%link%"><h3 style="color:#4b4b4b">%data%';
var HTMLworkTitle = ' - %data%</h3></a>';
var HTMLworkDates = '<div class="date-text">%data%</div>';
var HTMLworkLocation = '<div class="location-text">%data%</div>';
var HTMLworkDescription = '<p><br>%data%</p>';

var HTMLprojectStart = '<div class="project-entry" style="background: #a4eedf"></div>';
var HTMLprojectTitle = '<a href="#"><h3 style="color:#4b4b4b">%data%</h3></a>';
var HTMLprojectDates = '<div class="date-text">%data%</div>';
var HTMLprojectDescription = '<p><br>%data%</p>';
var HTMLprojectImage = '<img src="%data%" style="max-width:60%; max-height:60%; border: 2px solid black">';

var HTMLschoolStart = '<div class="education-entry"></div>';
var HTMLschoolName = '<a href="%link%">%data%';
var HTMLschoolDegree = ' -- %data%</a><span class="location"></span>';
var HTMLschoolDates = '<div class="date-text">%data%</div>';
var HTMLschoolLocation = '<div class="location-text">%data%</div>';
var HTMLschoolSeal = '<img src="%data%" style="max-width:200px; max-height:200px; border: 2px solid black">';
...
//This section will contain divs for further styling in the main divs that hold information

var HTMLbluestyling = '<div class="holder blue"></div>'
var HTMLgreenstyling = '<div class="holder green"></div>'
